function modelfinalscaled10 = importfile_weights(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   MODELFINALSCALED10 = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   MODELFINALSCALED10 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   modelfinalscaled10 = importfile('model_final_scaled_1_0.csv', 1, 132);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/08/30 12:48:28
...
modelfinalscaled10 = [dataArray{1:end-1}];
